          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 md:p-12">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-16 mb-4 md:mb-6">
              <div className="flex flex-col items-center">
                <img src="/Zimchina.png" alt="Zimbabwe-China Symposium" className="h-20 w-auto md:h-27 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <img src="/africapaciti.png" alt="Africapaciti" className="h-20 w-auto md:h-27 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <img src="/chamberlogo.png" alt="Chamber of Chinese Enterprises" className="h-20 w-auto md:h-27 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
            </div>
    ...
    <main className="min-h-screen">
      ...
      <div className="relative z-10 min-h-screen pt-8 md:pt-12 pb-12 md:pb-20">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          {/* Error Message */}
          {submitStatus === 'error' && (
            <div className="mb-6 p-4 bg-red-500/20 backdrop-blur-sm border border-red-500 rounded-xl text-white">
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-16 mb-4 md:mb-6">
              <div className="flex flex-col items-center">
                <img src="/Zimchina.png" alt="Zimbabwe-China Symposium" className="h-26 w-auto md:h-47 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <img src="/africapaciti.png" alt="Africapaciti" className="h-26 w-auto md:h-47 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <img src="/chamberlogo.png" alt="Chamber of Chinese Enterprises" className="h-26 w-auto md:h-47 hover:bg-white/60 hover:rounded-xl md:p-2 transition-all duration-300" />
              </div>
            </div>
            <p className="text-white/80 text-sm md:text-lg font-bold italic tracking-wide mt-2">Building Strategic Partnerships</p>
          </div>

          <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
            {/* Form Column */}
            <div className="w-full lg:w-2/3">
              <div className="bg-white/85 backdrop-blur-sm rounded-2xl shadow-xl p-5 md:p-8">
